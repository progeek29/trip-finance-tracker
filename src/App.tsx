...
export function App() {
  ...
  return (
    ...
    >
      ...
      <main key={activeTab} className={`tab-enter max-w-3xl mx-auto w-full flex-1 ${activeTab === 'chat' ? 'px-3 sm:px-6 pt-1 pb-1 flex flex-col min-h-0 overflow-hidden' : 'px-4 sm:px-6 py-6'}`}>
        {activeTab === 'trip' && (
          <CleanTripView
            trip={activeTrip}
